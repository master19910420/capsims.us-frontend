...
const rawApiBase = import.meta.env.VITE_API_URL || 'https://api.assessmentinternationalinc.com'
...
const DEFAULT_PROD_API_BASE = 'https://api.assessmentinternationalinc.com'
