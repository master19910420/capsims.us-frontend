...
const rawApiBase = import.meta.env.VITE_API_URL || 'https://api.assessmentsinternational.org'
...
const DEFAULT_PROD_API_BASE = 'https://api.assessmentsinternational.org'
