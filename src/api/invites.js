...
const rawApiBase = import.meta.env.VITE_API_URL || 'https://api.assessmentsinternationalsinc.com'
...
const DEFAULT_PROD_API_BASE = 'https://api.assessmentsinternationalsinc.com'
